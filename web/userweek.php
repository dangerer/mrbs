...
$baseurl = new moodle_url('/blocks/mrbs/web/userweek.php', ['day' => $day, 'month' => $month, 'year' => $year]); // Used as the basis for URLs throughout this file
    ...
    for ($thisday = 0; $thisday <= ($num_of_days - 1); $thisday++) {
        ...
        if (isset($descrs)) {
            for ($i = 0; $i < count($descrs); $i++) {
                ...
                $viewentry = new moodle_url('/blocks/mrbs/web/view_entry.php', ['id' => $ids[$i], 'area' => $area, 'day' => $wday,
