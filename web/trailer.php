...
if ($pview != 1) {
    ...
    for ($i = -6; $i <= 7; $i++) {
        ...
        $url = new moodle_url('/blocks/mrbs/web/day.php', array_merge(['year' => $cyear, 'month' => $cmonth, 'day' => $cday], $params));
    ...
    for ($i = -4; $i <= 4; $i++) {
        ...
        $url = new moodle_url('/blocks/mrbs/web/week.php', array_merge(['year' => $cyear, 'month' => $cmonth, 'day' => $cday], $params));
        echo "<a href=\"" . $url . "\">$str</a>\n";
        if ($i == 0) {
            echo ']</b> ';
        }
    ...
    for ($i = -2; $i <= 6; $i++) {
        ...
        $url = new moodle_url('/blocks/mrbs/web/month.php', array_merge(['year' => $cyear, 'month' => $cmonth], $params));
        echo "<a href=\"" . $url . "\">$str</a>\n";
        if ($i == 0) {
            echo ']</b> ';
        }
