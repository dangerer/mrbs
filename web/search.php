...
$thisurl = new moodle_url('/blocks/mrbs/web/search.php', ['day' => $day, 'month' => $month, 'year' => $year]);
if ($area) {
...
<div id="page-content">
  <div id="region-main-box">
    ...
    <h2><?= get_string('advanced_search', 'block_mrbs') ?></h2>
    <form method="get" action="search.php">
    
    <div id="fitem_id_search_str" class="form-group row fitem">
        <div class="col-md-3">
            <label class="col-form-label d-inline" for="id_search_str"><?= get_string('search_for', 'block_mrbs') ?></label>
        </div>
...
<TABLE BORDER=2 CELLSPACING=0 CELLPADDING=3>
    ...
    foreach ($result as $entry) {
        ...
        $dayurl = new moodle_url('/blocks/mrbs/web/day.php', ['day' => $link['mday'], 'month' => $link['mon'], 'year' => $link['year'],
            'area' => $entry->area_id]);
