...
$thisurl = new moodle_url('/blocks/mrbs/web/gotoroom.php', ['day' => $day, 'month' => $month, 'year' => $year, 'room' => $room]);
...
if ($area) {
    $areaurl = new moodle_url('/blocks/mrbs/web/day.php', ['day' => $day, 'month' => $month, 'year' => $year, 'area' => $area->area_id]);
    redirect($areaurl);
} else {
    $notfoundurl = new moodle_url('/blocks/mrbs/web/day.php', ['day' => $day, 'month' => $month, 'year' => $year, 'roomnotfound' => $room]);
