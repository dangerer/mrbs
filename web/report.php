...
function reporton(&$item, &$last_area_room, &$last_date, $sortby, $display)
{
    ...
    $viewurl = new moodle_url('/blocks/mrbs/web/view_entry.php', ['id' => $item->id]);
...
$thisurl = new moodle_url('/blocks/mrbs/web/report.php', ['day' => $day, 'month' => $month, 'year' => $year]);
...
<div id="page-content">
  <div id="region-main-box">
    ...
    <h2><?php echo get_string('report_on', 'block_mrbs'); ?></h2>    
    
    <form method="get" action="report.php">
    
      <div id="fitem_id_report_start" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_report_start"><?php echo get_string('report_start', 'block_mrbs') ?></label>
          </div>
      ...
      <div id="fitem_id_report_end" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_report_end"><?php echo get_string('report_end', 'block_mrbs') ?></label>
          </div>
          <div class="col-md-9 form-inline felement" data-fieldtype="text">
      ...
      <div id="fitem_id_match_area" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_match_area"><?php echo get_string('match_area', 'block_mrbs') ?></label>
          </div>
          <div class="col-md-9 form-inline felement" data-fieldtype="text">
      ...
      <div id="fitem_id_roommatch" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_roommatch"><?php echo get_string('match_room', 'block_mrbs') ?></label>
          </div>
          <div class="col-md-9 form-inline felement" data-fieldtype="text">
      ...
      <div id="fitem_id_match_type" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_match_type"><?php echo get_string('match_type', 'block_mrbs') ?></label>
          </div>
          <div class="col-md-9 form-inline felement" data-fieldtype="text">
              <select class="custom-select" name="typematch[]" multiple="yes">
                ...
                <em><?php echo get_string('ctrl_click_type', 'block_mrbs') ?></em>
          </div>          
      </div>  
      
      <div id="fitem_id_match_entry" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_match_entry"><?php echo get_string('match_entry', 'block_mrbs') ?></label>
          </div>
          <div class="col-md-9 form-inline felement" data-fieldtype="text">
      ...
      <div id="fitem_id_match_descr" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_match_descr"><?php echo get_string('match_descr', 'block_mrbs') ?></label>
          </div>
          <div class="col-md-9 form-inline felement" data-fieldtype="text">
      ...
      <div id="fitem_id_createdby" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_createdby"><?php echo get_string('createdby', 'block_mrbs') ?></label>
          </div>
          <div class="col-md-9 form-inline felement" data-fieldtype="text">
      ...
      <div id="fitem_id_include" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_include"><?php echo get_string('include', 'block_mrbs') ?></label>
          </div>
          <div class="col-md-9 form-inline felement" data-fieldtype="text">
                ...
                <?php
                  ...
                  "><label for='summarize1'><?= get_string('report_only', 'block_mrbs'); ?></label>
                </div>                  
                ...
                <div class="form-check form-check-inline">                  
                  ...
                  "><label for='summarize2'><?= get_string('summary_only', 'block_mrbs'); ?></label>
                </div>
                ...
                <div class="form-check form-check-inline">
                  ...
                  "><label for='summarize3'><?= get_string('report_and_summary', 'block_mrbs') ?></label>
                </div>
      ...
      <div id="fitem_id_sort_rep" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_sort_rep"><?php echo get_string('sort_rep', 'block_mrbs') ?></label>
          </div>
          <div class="col-md-9 form-inline felement" data-fieldtype="text">
            <div class="form-check form-check-inline">
    ...
    echo "><label for='sortby1'>" . get_string('room', 'block_mrbs'); ?></label>
            </div>
            <div class="form-check form-check-inline">
    ...
    echo "><label for='sortby2'>" . get_string('sort_rep_time', 'block_mrbs'); ?></label>
            </div>
          </div>          
      </div>    
      ...
      <div id="fitem_id_rep_dsp" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_rep_dsp"><?php echo get_string('rep_dsp', 'block_mrbs') ?></label>
          </div>
          <div class="col-md-9 form-inline felement" data-fieldtype="text">
            <div class="form-check form-check-inline">
    ...
    echo "><label for='display1'>" . get_string('rep_dsp_dur', 'block_mrbs'); ?></label>
            </div>                
    ...
    echo "><label for='display2'>" . get_string('rep_dsp_end', 'block_mrbs'); ?></label>
            </div>                
          </div>          
      </div>    
      ...
      <div id="fitem_id_summarize_by" class="form-group row fitem">         
          <div class="col-md-3">
              <label class="col-form-label d-inline" for="id_summarize_by"><?php echo get_string('summarize_by', 'block_mrbs') ?></label>
          </div>
          <div class="col-md-9 form-inline felement" data-fieldtype="text">
            <div class="form-check form-check-inline">
    ...
    echo "><label for='sumby1'>" . get_string('sum_by_descrip', 'block_mrbs'); ?></label>
              </div>
    ...
    echo "><label for='sumby2'>" . get_string('sum_by_creator', 'block_mrbs'); ?></label>
              </div>
          </div>          
      </div>                                             

          <em><?= get_string('help_wildcard', 'block_mrbs'); ?></em>
          <br /><hr />
            
          <div id='fitem_id_last_change' class='form-group row fitem'>
            <div class='col-md-3'></div>         
              <div class='col-md-9 felement' data-fieldtype="button"> 
                <button class="btn btn-success" type="submit" name="submitform" value="<?= get_string('submitquery', 'block_mrbs') ?>"><?= get_string('submitquery', 'block_mrbs') ?></button>
            </div>
          </div>  
    </form>
