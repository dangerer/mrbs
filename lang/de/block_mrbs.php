...
// $Id: block_mrbs.php,v 1.11 2009/11/07 14:50:34 arborrow Exp $
...
$string['mrbs:editmrbs_unconfirmed'] = 'Only create \'unconfirmed\' bookings (overriden by \'editmrbs\')';
...
$string['mrbs'] = 'Buchungssystem (RLP)';
$string['mrbsadmin'] = 'MRBS Administrator (RLP)';
$string['mrbsadmin_desc'] = 'Nutzer/innen mit dieser globalen Rolle können das Buchungssystem MRBS verwalten, Bereiche und Räume anlegen, Buchungen aller Personen ändern, Buchungen erzwingen und Doppelbuchungen vornehmen.';
$string['mrbseditor'] = 'MRBS Editor (RLP)';
...
$string['mrbsviewer'] = 'MRBS Viewer (RLP)';
