...
$options = [0 => get_string('pagewindow', 'block_mrbs'), 1 => get_string('newwindow', 'block_mrbs')];
...
/*
$modltifolder = new admin_category('blockmrbsfolder', new lang_string('pluginname', 'block_mrbs'));
// Add the Settings admin menu entry.
$ADMIN->add('modsettings', $modltifolder);
$settings->visiblename = new lang_string('settings', 'block_mrbs');
...
$ADMIN->add('modmrbsfolder', new admin_externalpage('mrbsmigration',
    get_string('libraries', 'mrbs'), new moodle_url('/blocks/mrbs/migration.php')));
    */
...
if (isset($cfg_mrbs->enable_periods)) {
    if ($cfg_mrbs->enable_periods == 0) {
        ...
        $settings->add(new admin_setting_configtextarea('periods', get_string('config_periods', 'block_mrbs'), get_string('config_periods2', 'block_mrbs'), $custom_periods));
...
$settings->add(new admin_setting_configselect('weekstarts', get_string('config_weekstarts', 'block_mrbs'), get_string('config_weekstarts2', 'block_mrbs'), 1, $options));
...
//Date Format
unset($options);
$options = [0 => get_string('config_date_mmddyy', 'block_mrbs'), 1 => get_string('config_date_ddmmyy', 'block_mrbs')];
...
$options = ['both' => get_string('both', 'block_mrbs'), 'description' => get_string('description'), 'slot' => get_string('slot', 'block_mrbs')];
...
$options = ['bgcolor' => get_string('bgcolor', 'block_mrbs'), 'class' => get_string('class', 'block_mrbs'), 'hybrid' => get_string('hybrid', 'block_mrbs')];
...
$options = ['day' => get_string('day'), 'month' => get_string('month', 'block_mrbs'), 'week' => get_string('week')];
...
$type_h = "AG";
$type_i = get_string('internal', 'block_mrbs');
$type_j = "Vertretung";

$settings->add(new admin_setting_configtext('entry_type_a', get_string('config_entry_type', 'block_mrbs', 'A'), get_string('config_entry_type2', 'block_mrbs', 'A'), $type_a, PARAM_TEXT));
$settings->settings->entry_type_a->plugin = 'block/mrbs';

$settings->add(new admin_setting_configtext('entry_type_b', get_string('config_entry_type', 'block_mrbs', 'B'), get_string('config_entry_type2', 'block_mrbs', 'B'), $type_b, PARAM_TEXT));
$settings->settings->entry_type_b->plugin = 'block/mrbs';

$settings->add(new admin_setting_configtext('entry_type_c', get_string('config_entry_type', 'block_mrbs', 'C'), get_string('config_entry_type2', 'block_mrbs', 'C'), $type_c, PARAM_TEXT));
$settings->settings->entry_type_c->plugin = 'block/mrbs';

$settings->add(new admin_setting_configtext('entry_type_d', get_string('config_entry_type', 'block_mrbs', 'D'), get_string('config_entry_type2', 'block_mrbs', 'D'), $type_d, PARAM_TEXT));
$settings->settings->entry_type_d->plugin = 'block/mrbs';

$settings->add(new admin_setting_configtext('entry_type_e', get_string('config_entry_type', 'block_mrbs', 'E'), get_string('config_entry_type2', 'block_mrbs', 'E'), $type_e, PARAM_TEXT));
$settings->settings->entry_type_e->plugin = 'block/mrbs';

$settings->add(new admin_setting_configtext('entry_type_f', get_string('config_entry_type', 'block_mrbs', 'F'), get_string('config_entry_type2', 'block_mrbs', 'F'), $type_f, PARAM_TEXT));
$settings->settings->entry_type_f->plugin = 'block/mrbs';

$settings->add(new admin_setting_configtext('entry_type_g', get_string('config_entry_type', 'block_mrbs', 'G'), get_string('config_entry_type2', 'block_mrbs', 'G'), $type_g, PARAM_TEXT));
$settings->settings->entry_type_g->plugin = 'block/mrbs';

$settings->add(new admin_setting_configtext('entry_type_h', get_string('config_entry_type', 'block_mrbs', 'H'), get_string('config_entry_type2', 'block_mrbs', 'H'), $type_h, PARAM_TEXT));
$settings->settings->entry_type_h->plugin = 'block/mrbs';

$settings->add(new admin_setting_configtext('entry_type_i', get_string('config_entry_type', 'block_mrbs', 'I'), get_string('config_entry_type2', 'block_mrbs', 'I'), $type_i, PARAM_TEXT));
$settings->settings->entry_type_i->plugin = 'block/mrbs';

$settings->add(new admin_setting_configtext('entry_type_j', get_string('config_entry_type', 'block_mrbs', 'J'), get_string('config_entry_type2', 'block_mrbs', 'J'), $type_j, PARAM_TEXT));
